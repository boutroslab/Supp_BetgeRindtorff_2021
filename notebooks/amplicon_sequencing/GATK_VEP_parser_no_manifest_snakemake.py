...
'Amino_acids', 'Codons', 'Existing_variation', 'IMPACT', 'SYMBOL', 'CANONICAL', \
'BIOTYPE', 'SIFT', 'PolyPhen', 'EXON', 'gnomAD_AF', 'CLIN_SIG', 'PUBMED']
...
for root, dirs, files in os.walk(vcf_directory):
    for name in files:
        if "no_manifest_output_VEP.vcf" in name and "html" not in name and "warnings" not in name:
